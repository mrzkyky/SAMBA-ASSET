...
-- Assets in Brebes Kota (site_id: 1)
...
-- Assets in Substation Jatibarang (site_id: 2)
...
-- Assets in Gedung Sate Core (site_id: 5)
...
-- Assets in Gubeng Core Surabaya (site_id: 6)
...
-- Assets in Sudirman Hub Jakarta (site_id: 8)
